...
class Blip2VicunaXInstruct(Blip2Base):
    ...
    def init_image_encoder(self, 
        ...
        encoder, _ = super().init_vision_encoder(kwargs['image_size'], kwargs['drop_path_rate'], kwargs['use_grad_checkpoint'], precision)
    ...
    def generate(
        ...
        return {
            ...
            "duration": samples["duration"].tolist() if isinstance(samples["duration"], torch.Tensor) else samples["duration"],
        }
