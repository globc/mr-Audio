...
class MomentRetrievalDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        #task_prompt = "Given the multimodal information from the video (which integrates both visual features and audio cues), and the query, find the relevant windows.\nRelevant windows: "
